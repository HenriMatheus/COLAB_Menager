...
const autenticate = require("./middleware/autenticate.js")

router.get("/", (req, res) => res.redirect(`${process.env.AUTHORIZATION_ENDPOINT}?response_type=code&client_id=${process.env.CLIENT_ID}&redirect_uri=${process.env.REDIRECT_URI}&scope=identificacao+email`))
router.get("/oauth", usersControll.oauth)
router.get("/login", usersControll.login)
