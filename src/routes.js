...
router.get("/outstandingLoans", /*autenticate*/ loanController.getOutstandingLoans)
router.post("/aceptNewLoan", /*autenticate*/ loanController.aceptLoan)
router.post("/rejectNewLoan", /*autenticate*/ loanController.rejectLoan)
